<template>
    <div class="card">
        <div class="card-header bg-secondary text-white">
            <i class="fa fa-align-justify"></i> REINSTALACIÓN
...
<script>
    ...
    export default {        
        ...
        methods : {
            ...
            registrarReinstalacion(actividad){
                ...
                axios.post('/reinstalaciones/registrar', {
            ...
            validarReinstalacion(){
                ...
                if(!this.placa) this.errorMostrarMsjReinstalacion.push("DEBE INGRESAR UNA PLACA.");
                if(!this.nombre) this.errorMostrarMsjReinstalacion.push("DEBE INGRESAR UNA PLACA.");
                if(!this.id_dispositivo) this.errorMostrarMsjReinstalacion.push("DEBE INGRESAR EL ID DEL GPS.");
                if(!this.lugar) this.errorMostrarMsjReinstalacion.push("DEBE INGRESAR UN LUGAR.");
