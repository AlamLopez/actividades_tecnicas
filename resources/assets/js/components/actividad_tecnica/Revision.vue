<template>
    <div class="card">
        <div class="card-header bg-secondary text-white">
            <i class="fa fa-align-justify"></i> NUEVA REVISIÓN
    ...
    export default {        
        ...
        methods : {
            ...
            registrarRevision(actividad){
                ...
                axios.post('/revisiones/registrar', {
            ...
            validarRevision(){
                ...
                if(!this.nombre) this.errorMostrarMsjRevision.push("DEBE INGRESAR EL NOMBRE.");
                if(!this.placa) this.errorMostrarMsjRevision.push("DEBE SELECCIONAR UNA PLACA.");
                if(!this.lugar) this.errorMostrarMsjRevision.push("DEBE INGRESAR UN LUGAR.");
